...
<span style="color: white;">Natalia Morandeira</span>

<span style="color: white; font-size: 15px">_Podés explorar el territorio y leer el cuento en el orden que elijas. Si preferís leer en orden cronológico, hacé click aquí</span>
...
<span style="color: white; font-size: 15px">_En esta versión, cada punto tiene un número que indica el orden cronológico. Si preferís volver a la versión sin números, hacé click aquí</span>

```{r mapafinal_num}
#Cada punto corresponde a un marcador con una etiqueta con el relato. 


icons_num <- c("circle-1", "circle-1", "circle-3", "circle-4", "circle-5")
icons <- awesomeIcons(
  icon = icons_num,
  library = fa,
  iconColor = 'white',
