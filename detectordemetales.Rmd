...
[Versión accesible](https://github.com/nmorandeira/detectordemetales/blob/main/detectordemetales.md) para lectores de pantalla (para personas ciegas, con visión limitada u otras dificultades para interactuar con el mapa).
</span>
