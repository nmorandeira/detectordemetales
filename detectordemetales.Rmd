...
mapa_base <-leaflet(width="100%", height = "75%") %>% 
  addProviderTiles("Stamen.Watercolor", group="Acuarela", options = providerTileOptions(attribution = "Acuarela de fondo: Stamen Design Watercolor, licencia CC BY 3.0. Datos OpenStreetMap, licencia CC BY SA 2.0" )) %>%
  addProviderTiles("OpenStreetMap.Mapnik", group = "Mapa", options = providerTileOptions(attribution = "Mapa de fondo: © OpenStreetMap contributors, licencia CC BY-SA 2.0" )) %>%
